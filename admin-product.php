...
<body>
    ...
    <div class="container">
        ...
        <form method="post" enctype="multipart/form-data">
            ...
            <input type="number" min='0' name="product_price" placeholder="Цена" required>
            <input type="number" min='0' name="product_amount" placeholder="Количество на складе" required>
            <input type="number" min='0' name="product_year" placeholder="Год выпуска" required>
                    ...
                    <tr>
                        <form method="post">
                            <td>
                                ...
                                <input type="number" min='0' name="product_price" value="<?= $product['price'] ?>">
                                <input type="number" min='0' name="product_amount" value="<?= $product['amount'] ?>">
                                <input type="number" min='0' name="product_year" value="<?= $product['year'] ?>">
                                <select name="product_type_id">
